...
export const Definitions = {
  ...
  session_next: keybind("alt+right", "Go to next session"),
  session_previous: keybind("alt+left", "Go to previous session"),
  ...
  messages_previous: keybind("alt+up,ctrl+alt+[", "Navigate to previous user message"),
...
export const CommandMap = {
  ...
  session_previous: "session.previous",
